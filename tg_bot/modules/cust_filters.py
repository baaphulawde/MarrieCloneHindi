                ...
                try:
                    ...
                    if excp.message == "Unsupported url protocol":
                        message.reply_text("You seem to be trying to use an unsupported url protocol. Telegram "
                                           ...
                                           "again, or ask in @king_un_007 for help.")
                        ...
                        message.reply_text("This note could not be sent, as it is incorrectly formatted. Ask in "
                                           "@king_un_007 if you can't figure out why!")
...
def __chat_settings__(chat_id, user_id):
    ...
    return "Total `{}` filters group me added h.".format(len(cust_filters))


__help__ = """
 - /filters: Sabhi filters ki list.

*Admin only:*
 - /filter <keyword> <reply message>: Group ke andar filter add karne ke liye ye use kare. Jab bhi koi member including admins and the owner filtered word use karega \
to ye jis text,gif,pic,sticker ko filter kiya hua hoga bot ki taraf se send hoga immediately  NOTE: all filter \
