    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text("Bhau agyela h @admins Seva me lag jao! Welcome bhau @king_un_007 Group chota h par apko koi taklif nhi hone denge ")
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text("Vaps Jaldi Ana Bhau @king_un_007 ")
                return
...
def goodbye(bot: Bot, update: Update, args: List[str]):
    ...
    if len(args) == 0 or args[0] == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text("It feel like me mar jaunga jab koi leave karta h!")
...
def set_welcome(bot: Bot, update: Update) -> str:
    ...
    msg.reply_text("Successfully custom welcome msg set ho gya!")
