        ...
        if re.search(pattern, to_match, flags=re.IGNORECASE):
            try:
                ...
                if excp.message == "Message to delete not found":
                    ...
                    LOGGER.exception("Error while deleting blacklist message. KUCH TO GADBAD H DAYA")
            break
...
__help__ = """
Blacklist ke andar jo words honge,un words ko group me use karte hi wo delete ho jaenge , \
Admins ke words delete nhi honge!

......

 - /blacklist: current blacklisted words ki list

*Admin only:*
 - /addblacklist <triggers>: Add a word to the blacklist. har ek line pe ek trigger \
     isse ek sath 1+ triggers add kar sakte h
 - /unblacklist <triggers>: Remove a word from the blacklist. Same newline logic applies here, so you can remove \
